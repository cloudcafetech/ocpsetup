...
yum install -q -y yum-utils device-mapper-persistent-data lvm2 git curl wget bind-utils jq httpd-tools zip unzip nfs-utils nmap telnet dos2unix java-1.8.0-openjdk
...
wget -q https://raw.githubusercontent.com/cloudcafetech/ocpsetup/master/nfsstorage-setup.sh
chmod +x ./nfsstorage-setup.sh
#./nfsstorage-setup.sh

# Kafka setup
wget -q https://raw.githubusercontent.com/cloudcafetech/kafka-on-container/master/kafka-setup.sh
